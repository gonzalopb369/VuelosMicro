...
namespace Vuelos.Domain.Model.Vuelos
{
    public class VueloProgramado : Entity<Guid>
    {
        ...
        public decimal PrecioVuelo { get; private set; }    // !!! hacer value objects
        public decimal CantidadMillas { get; private set; }
        ...
        internal VueloProgramado(NroVueloValue nroVuelo, bool lunes, bool martes, bool miercoles, bool jueves, bool viernes,
                                ...
                                CodigoCiudadValue ciudadDestino, decimal precioVuelo, decimal cantidadMillas)
        {
            Id = Guid.NewGuid();
            NroVuelo = nroVuelo;
            Lunes = lunes;
